        ...
        <footer className="bg-black/30 border-t border-white/10 text-white py-12 relative">
            <div className="container mx-auto px-6 text-center">
                <a href="#" className="flex items-center justify-center space-x-2">
                    ...
                    <span className="text-3xl font-bold">Serve<span className="text-red-500">athon</span></span>
                </a>
                ...
                <div className="flex justify-center space-x-6 mt-6">
                    ...
                    <a href="#" className="text-gray-400 hover:text-red-400 transition">LinkedIn</a>
                    <a href="#" className="text-gray-400 hover:text-red-400 transition">GitHub</a>
                </div>
                <p className="mt-8 text-gray-500 text-sm">&copy; 2025 Serveathon. All rights reserved.</p>
            </div>
        </footer>
    );
}
